...
namespace MadWizard.Insomnia.Manager.Processes
{
    public static class ProcessLauncher
    {
        public static Process CreateProcessInSession(ProcessStartInfo startup, uint sid, string processName = "winlogon")
        {
        ...
        public static Process CreateProcessInSession(ProcessStartInfo startup, nint token)
        {
